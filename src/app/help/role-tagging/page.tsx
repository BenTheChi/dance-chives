      ...
      <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto p-6 md:p-8 pb-16">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <Image
              src="/screenshots/SearchforInstagram1.png"
              alt="Search for Instagram"
              width={1000}
              height={1000} 
              className="border-4 border-secondary-light rounded-sm"
            />
            ...
            <Image
              src="/screenshots/tagwithunclaimedinstagram1.png"
              alt="Tag with Unclaimed Instagram"
              width={1000}
              height={1000}
              className="border-4 border-secondary-light rounded-sm"
            />
            <p className="text-base leading-relaxed ml-16 text-white">Once you have added the account, you will need to submit your request. The request will be sent for administration approval. </p>
          </div>
