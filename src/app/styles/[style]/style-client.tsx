...
export function StyleClient({
  ...
  const cityName = cityFilteredEvents && cityFilteredEvents.length > 0
  ...
  return (
    <>
      ...
      {(!cityFilteredEvents || cityFilteredEvents.length === 0) && allEvents.length > 0 && (
        <section className="mb-12">
