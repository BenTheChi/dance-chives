  ...
  return (
    <div className={cn("flex flex-col debounced-search-select", className)}>
      ...
      <div className="relative w-full">
        <div className="flex items-center border rounded-sm bg-fog-white">
          ...
          <Input
            ...
            className="border-0 p-2 shadow-none focus-visible:ring-0 flex-1 bg-fog-white"
            disabled={disabled}
          />
          {isLoading ? (
        ...
        {open && (
          <div className="absolute z-50 w-full mt-1 bg-fog-white border rounded-sm shadow-lg">
            <Command className="bg-fog-white">
              <CommandList>
                <CommandGroup>
