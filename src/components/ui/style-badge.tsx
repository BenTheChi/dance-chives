...
export function StyleBadge({
  ...
  const badgeClasses = cn(
    "text-black bg-fog-white border border-charcoal font-semibold text-xs px-1 py-0.5 rounded inline-flex items-center justify-center leading-none gap-1 !text-[14px]",
    asLink &&
      !showRemoveButton &&
