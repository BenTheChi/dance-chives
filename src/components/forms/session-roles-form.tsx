...
interface SessionRolesFormProps {
  control: Control<any>;
...
// This component is used to render the roles form in the session creation process.
export default function SessionRolesForm({
  control,
  setValue,
  roles,
}: SessionRolesFormProps) {
