...
import { FreestyleVideo as FreestyleVideoType } from "@/types/video";
...
interface FreestyleVideoProps {
  video: FreestyleVideoType;
  eventLink: string;
  eventTitle: string;
  sectionTitle?: string;
  bracketTitle?: string;
...
export function FreestyleVideo({
  video,
  eventLink,
  eventTitle,
  sectionTitle,
  ...
  return (
    <CardWithPoster className="group cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] border-2 border-green-500">
